...
export default function CreateCase() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.deceased_name)
      return setError("Please enter the deceased person's name.");
    if (!form.date_of_death) return setError("Please enter the date of death.");
    if (form.institutions.length === 0)
      return setError("Please select at least one institution.");
    if (!form.nominee_name) return setError("Please enter the nominee name.");
    if (
      !form.nominee_relation ||
      form.nominee_relation === "Select Relationship"
    )
      return setError("Please select nominee relation.");
      ...
      {loading && (
        <div className="fixed inset-0 bg-white/90 backdrop-blur-sm z-50 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-lg font-semibold text-gray-800">
            AI is generating your recovery plan...
          </p>
          ...
          {[
            ...
            <div key={step.num} className="flex items-center">
              ...
              >
                ...
                <div>
                  <p
                    className={`text-xs font-semibold ${activeStep >= step.num ? "text-blue-600" : "text-gray-400"}`}
                  >
                    {step.label}
                  </p>
              ...
              {idx < 2 && (
                <div
                  className={`w-16 h-px mx-3 ${activeStep > step.num ? "bg-blue-600" : "bg-gray-200"}`}
                />
              )}
            </div>
          ))}
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-xs text-gray-400 mb-4">
                  Select the institutions where the deceased held accounts or
                  investments.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm({ ...form, nominee_relation: e.target.value })
                      }
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                ...
                <p className="text-xs text-blue-600 leading-relaxed">
                  The documentation you provide is verified against
                  institutional records to streamline the legal transfer of
                  assets. Ensuring accuracy here prevents delays in the 4-6 week
                  processing window.
                </p>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-mono font-semibold text-gray-700">
                      GW-{Math.floor(Math.random() * 9000 + 1000)}-A
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
